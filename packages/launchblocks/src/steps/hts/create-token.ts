...
export const htsCreateToken = defineStep({
  ...
  ui: {
    ...
    fields: [
      ...
      { key: "keys.admin", label: "Admin key", kind: "boolean", help: "Update or delete the token later" },
      { key: "keys.supply", label: "Supply key", kind: "boolean", help: "Mint or burn later" },
      { key: "keys.freeze", label: "Freeze key", kind: "boolean" },
      { key: "keys.wipe", label: "Wipe key", kind: "boolean" },
      { key: "keys.pause", label: "Pause key", kind: "boolean" },
      { key: "keys.kyc", label: "KYC key", kind: "boolean" },
      { key: "keys.feeSchedule", label: "Fee schedule key", kind: "boolean", help: "Change custom fees later" },
      { key: "fractionalFee.numerator", label: "Fee numerator", kind: "number", help: "1 with denominator 100 = 1%" },
      { key: "fractionalFee.denominator", label: "Fee denominator", kind: "number" },
      {
